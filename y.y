...
%% 
	...
	EXPRESION: PROCEDIMIENTO | VAR | COMEN | CICLO |EXPRESION EXPRESION;
	CICLO: LOOP PARENTESIS_A ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA PARENTESIS_C INI_LOOP EXPRESION FIN_LOOP PUNTO_COMA; 
	COMEN: COMENTARIO_I PALABRAS COMENTARIO_F | COMENTARIO_I COMENTARIO_F;
	PALABRAS: PALABRAS PALABRAS | NOMBRE | NUMERO | VARIABLE;
