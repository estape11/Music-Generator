...
%% 
	...
	PROCEDIMIENTO: 
				NOMBRE PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO NOMBRE PUNTO_COMA 
				|COMEN NOMBRE PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO NOMBRE PUNTO_COMA 
				|NOMBRE PARENTESIS_A PARENTESIS_C COMEN COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO NOMBRE PUNTO_COMA 
				|NOMBRE PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO COMEN NOMBRE PUNTO_COMA
				|NOMBRE PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO NOMBRE COMEN PUNTO_COMA
				|NOMBRE PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO NOMBRE PUNTO_COMA COMEN
				|PROCEDIMIENTO PROCEDIMIENTO;	
				
	FUNCION_PRINCIPAL:
				F_PRINCIPAL PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO PUNTO_COMA
				|F_PRINCIPAL PARENTESIS_A PARENTESIS_C COMEN COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO PUNTO_COMA
				|F_PRINCIPAL PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO COMEN PUNTO_COMA
				|F_PRINCIPAL PARENTESIS_A PARENTESIS_C COMENZAR EXPRESION FINALIZAR_PROCEDIMIENTO PUNTO_COMA COMEN;
	...
	CICLO:
				...
				| LOOP PARENTESIS_A ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA PARENTESIS_C INI_LOOP EXPRESION FIN_LOOP COMEN PUNTO_COMA
				| LOOP PARENTESIS_A ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA COMA ENTRADA PARENTESIS_C INI_LOOP EXPRESION FIN_LOOP PUNTO_COMA COMEN
				| CICLO CICLO; 
	...
	COND: 		
				...
				| CONDICION PARENTESIS_A VARIABLE COMA COMPARACIONES COMA NUMERO PARENTESIS_C ENTONCES EXPRESION CONTRARIO EXPRESION FIN_CONDICION COMEN PUNTO_COMA;
				| CONDICION PARENTESIS_A VARIABLE COMA COMPARACIONES COMA NUMERO PARENTESIS_C ENTONCES EXPRESION CONTRARIO EXPRESION FIN_CONDICION PUNTO_COMA COMEN;
				| COND COND ;
	...
	SILENC:
			SILENCIO PARENTESIS_A ENTRADA PARENTESIS_C PUNTO_COMA
			| SILENC SILENC;
